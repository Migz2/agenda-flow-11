  ...
  return (
    <div className="flex-1 p-4 lg:p-8 overflow-y-auto">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <StatCard label="Tarefas Completas" value={String(totalCompleted)} change={`${totalPending} pendentes`} color={c3} />
        <StatCard label="Total de Tarefas" value={String(allTasks.length)} change="todas as tarefas" color={c2} />
        <StatCard label="Taxa de Conclusão" value={`${rate}%`} change={rate >= 70 ? "Ótimo!" : "Continue!"} color={c1} />
        <StatCard label="Categorias Ativas" value={String(customCats.length)} change="categorias criadas" color={c4} />
      </div>
